...
echo "=========================================="
echo "  $APP_NAME - iOS Release Build"
echo "=========================================="
...
npx eas-cli submit --platform ios --profile production --non-interactive || echo "Submit skipped"

echo "  $APP_NAME iOS build complete! Version: $NEW_VERSION"
