...
class CreateSquadsScreenWizard extends StatefulWidget {
  final PlayerProfile playerProfile;

  const CreateSquadsScreenWizard({
    super.key,
    required this.playerProfile,
  });

  @override
  State<CreateSquadsScreenWizard> createState() => _CreateSquadsScreenWizardState();
}

class _CreateSquadsScreenWizardState extends State<CreateSquadsScreenWizard> with SingleTickerProviderStateMixin {
