...
export const Route = createFileRoute("/anspruch-pruefen/")({
  head: () => ({
    meta: [
      { title: "Anspruch prüfen – Konsumentenretter" },
      {
        name: "description",
        content:
          "Wählen Sie Ihren Anspruch: Kreditbearbeitungsgebühren, Online-Casino Verluste oder Handy- und Internetverträge. Kostenlos & ohne Risiko.",
      },
      { property: "og:title", content: "Anspruch prüfen – Konsumentenretter" },
      {
        property: "og:description",
        content:
          "Drei Wege Ihr Geld zurückzuholen – wählen Sie Ihren Fall. Kostenlos und ohne Prozessrisiko.",
      },
    ],
  }),
  component: AnspruchAuswahl,
});

const cases = [
  {
    slug: "kredit",
    title: "Kredit­bearbeitungs­gebühren",
    short: "Bei Kredit- oder Leasingverträgen",
    desc: "Wir holen unzulässig verrechnete Bearbeitungs­gebühren aus Ihrem Kredit- oder Leasingvertrag zurück.",
    icon: Banknote,
  },
  {
    slug: "telekom",
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="mx-auto max-w-7xl px-6 lg:px-10 py-16 lg:py-24">
        <div className="max-w-3xl">
          ...
          <h1 className="mt-6 text-[40px] sm:text-5xl lg:text-6xl leading-[1.05] tracking-tight text-ink text-balance">
            Welchen <span className="font-serif italic text-brand-deep">Anspruch</span> möchten Sie prüfen lassen?
          </h1>
          ...
          {cases.map((c, i) => {
            ...
            return (
              ...
              >
                ...
                <h2 className="mt-6 text-xl font-semibold text-ink leading-tight">{c.title}</h2>
