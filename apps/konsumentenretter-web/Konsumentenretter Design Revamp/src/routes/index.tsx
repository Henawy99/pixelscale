  ...
  head: () => ({
    meta: [
      { title: "Konsumentenretter – Wir holen Ihr Geld zurück" },
      {
        name: "description",
        content:
          "Kreditgebühren, Servicepauschalen und Online-Casino Verluste in Österreich kostenlos und ohne Risiko zurückfordern.",
      },
      { property: "og:title", content: "Konsumentenretter – Ihr Geld. Zurück." },
      {
        property: "og:description",
        content:
          "Als Konsument in Österreich haben Sie Ansprüche. Wir setzen sie durch – kostenlos und ohne Risiko.",
      },
    ],
  }),
  component: Index,
...
function Nav() {
  const links: { to?: string; params?: { typ: string }; href?: string; label: string }[] = [
    { to: "/anspruch-pruefen/$typ", params: { typ: "kredit" }, label: "Kreditgebühren" },
    { to: "/anspruch-pruefen/$typ", params: { typ: "telekom" }, label: "Servicepauschalen" },
    { to: "/anspruch-pruefen/$typ", params: { typ: "casino" }, label: "Online Casino" },
    ...
    <section className="relative">
      <div className="mx-auto max-w-7xl px-6 lg:px-10 pt-10 lg:pt-16 pb-20 lg:pb-28 grid lg:grid-cols-12 gap-10 lg:gap-14 items-center">
        <div className="lg:col-span-7">
          ...
          <h1 className="mt-6 text-[44px] sm:text-6xl lg:text-7xl leading-[1.02] tracking-tight text-ink text-balance">
            Ihr Geld.{" "}
            <span className="font-serif italic text-brand-deep">Zurück</span> –
            <br className="hidden sm:block" /> wo es Ihnen{" "}
            <span className="font-serif italic">zusteht</span>.
          </h1>
          ...
          <div className="mt-9 flex flex-wrap items-center gap-3">
            <Link
              to="/anspruch-pruefen"
              className="inline-flex items-center gap-2 rounded-full bg-brand text-primary-foreground px-6 py-3.5 text-[15px] font-medium hover:bg-brand-deep transition-colors shadow-[0_8px_24px_-8px_oklch(0.58_0.22_255/0.5)]"
            >
        ...
        <div className="lg:col-span-5 relative">
          ...
          <div className="absolute -right-4 top-10 hidden sm:flex flex-col items-end rounded-2xl bg-ink text-background px-4 py-3 ring-soft">
            ...
            <span className="text-xs opacity-70 mt-1">für unsere Mandanten</span>
          </div>
        </div>
      </div>
    </section>
...
const services = [
  {
    ...
    title: "Unzulässige Kredit­bearbeitungs­gebühren",
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        <div className="flex items-end justify-between gap-10 flex-wrap mb-14">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-4 text-4xl lg:text-5xl tracking-tight text-ink text-balance">
              Drei Bereiche, in denen wir{" "}
              <span className="font-serif italic">Ihr Recht</span> durchsetzen.
            </h2>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-5">
          {services.map((s) => (
            ...
            >
              ...
              <h3 className="text-2xl text-ink leading-snug text-balance">
                {s.title}
              </h3>
    ...
    <section id="ablauf" className="relative py-24 lg:py-32 bg-background text-ink overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-10 relative">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h2 className="mt-4 text-3xl lg:text-5xl tracking-tight text-balance leading-[1.15]">
            Starten Sie in nur <span className="font-serif italic text-brand">2 Minuten</span> und reichen Sie Ihr Anliegen{" "}
            <span className="font-semibold">einfach und schnell</span> bei uns ein – ohne Papierkram und Aufwand.
          </h2>
        </div>

        <ol className="mt-16 grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {steps.map((s, i) => (
            <li
              key={s.n}
    ...
    <section className="py-24 lg:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-10 grid lg:grid-cols-12 gap-12">
        <div className="lg:col-span-5">
          ...
          <h2 className="mt-4 text-4xl lg:text-5xl tracking-tight text-ink text-balance">
            Wir sind die{" "}
            <span className="font-serif italic">leise Stimme</span> an Ihrer Seite –
            ...
            <div key={p.title} className="bg-card p-7 lg:p-8 group">
              <div className="relative inline-flex">
                <div
                  ...
                  aria-hidden
                />
                <div className="relative grid place-items-center size-14 rounded-2xl bg-gradient-to-br from-brand-deep to-brand text-primary-foreground shadow-lg shadow-brand-deep/30 ring-1 ring-white/20 group-hover:-translate-y-0.5 transition-transform">
        ...
        <div className="relative rounded-[2rem] bg-gradient-to-br from-brand-deep via-brand-deep to-brand p-10 lg:p-16 overflow-hidden">
          ...
          <div className="relative grid lg:grid-cols-12 gap-10 items-end">
            <div className="lg:col-span-8">
              ...
              <h2 className="mt-4 text-4xl lg:text-6xl tracking-tight text-background text-balance">
                Lassen Sie Ihren Anspruch{" "}
                <span className="font-serif italic">kostenlos prüfen</span>.
              </h2>
            ...
            <div className="lg:col-span-4 flex lg:justify-end">
              <Link
                to="/anspruch-pruefen"
                className="inline-flex items-center gap-2 rounded-full bg-background text-ink px-7 py-4 text-[15px] font-medium hover:bg-gold hover:text-ink transition-colors"
              >
    ...
    <div>
      ...
      <ul className="mt-4 space-y-2.5">
        {links.map(([label, href]) => (
          <li key={label}>
            <a href={href} className="text-muted-foreground hover:text-ink transition-colors">
              {label}
            </a>
          </li>
        ))}
...
function SectionLabel({
  ...
  return (
    <p
      className={`text-xs uppercase tracking-[0.2em] text-brand font-medium ${className}`}
    >
      {children}
    </p>
  );
