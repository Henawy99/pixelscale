"""
ACCURATE Ball Tracking with Perspective Correction

- Uses yolov8l for ACCURACY (can detect small/fast balls)
- Optimized settings for speed (3x faster than precision script)
...
print(f"⚽ ACCURATE Ball Tracking with Perspective Correction")
...
print(f"✨ Optimizations: IMG_SZ={IMG_SZ} (balanced), INTER_LINEAR (fast)")
...
print(f"✅ Accurate Ball Tracking complete in {elapsed:.1f}s")
